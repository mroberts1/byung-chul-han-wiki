---
title: Decreation
aliases: ["Ent-schöpfung", "de-creation"]
tags:
  - shanzhai
  - process
  - emptiness
...
In the context of [[Shanzhai - Deconstruction in China|*Shanzhai*]], decreation names what the shanzhai movement performs: it opposes identity with transformational difference, Being with process, essence with path. **Shanzhai is decreation.**

Han distinguishes decreation from the Western notion of ruins. Ruins presuppose an identity founded on a unique event — a rupture, a loss that must be preserved. Chinese thought has no ruins because it knows no such founding events; there is nothing to memorialize, only process to continue.
